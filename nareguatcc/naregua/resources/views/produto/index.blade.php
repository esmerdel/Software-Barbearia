                ...
                @foreach($produtos as $produto)
                    <tr>
                        ...
                        <td class="d-flex gap-2 justify-content-center">
                            <a href="{{ route('produto.edit', $produto) }}" class="btn btn-sm btn-outline-warning">Editar</a>
                            <form action="{{ route('produto.destroy', $produto) }}" method="POST" class="form-excluir">
                                @csrf
                                @method('DELETE')
